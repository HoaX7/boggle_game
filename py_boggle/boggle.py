...
class BoggleGame:
    ...
    def init_game(self):
        dictionary = parse_boggle_dict()
        self.__screen.set_title(TITLE)
        self.__screen.set_board(self.get_board())
        self.__screen.set_dict(dictionary)

    def get_board(self):
        board_dict = {}
        self.board = randomize_board()
        self.__screen.set_raw_board(self.board)
        self.__screen.set_blocks(list(chain.from_iterable(self.board))) # Flatten and set board letters
